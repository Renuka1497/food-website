...
<nav id="navbar">
        ...
        <ul>
            ...
            <li class="item"><?php echo $_SESSION['email']; ?> </li>  
        </ul>
       
    </nav>

    <section id="home">
        <h1 class="h-primary">Welcome to Nikki Bakes Happiness</h1>
    ...
    <section id="client-section">
        ...
        <div id="clients">
            <div class="client-item">
                <img src="insta.jpg" alt="Our Client">
            </div>
            <div class="client-item">
                <img src="twittr.webp" alt="Our Client">
            </div>
        </div>
